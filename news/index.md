...
- [`boot_cuminc2ts()`](https://angelacar.github.io/TwoTimeScales/reference/boot_cuminc2ts.md)
  a wrapper function to perform non-parametric bootstrap to obtain
  uncertainty measures for the cumulative incidence functions and
  survival function.
- [`plot_boot_cuminc2ts()`](https://angelacar.github.io/TwoTimeScales/reference/plot_boot_cuminc2ts.md)
  plots an image of the point wise bootstrap SEs or confidence intervals
