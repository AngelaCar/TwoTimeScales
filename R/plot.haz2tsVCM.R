...
#'
#' @description  `plot.haz2tsVCM()` is the plot method for objects of class `haz2tsVCM`.
...
#'
#' @param x The output of the function `fitvcm()`. This is an object of
#'   class `"haz2tsVCM"`.
