...
#'
#' @description  `plot.haz2tsPGAM()` is the plot method for objects of class `haz2tsPGAM`.
...
#'
#' @param x The output of the function `fitpgam()`. This is an object of
#'   class `"haz2tsPGAM"`.
#' @param which_plot The type of plot required. Can be one of `"hazard"`
#'   (default), `"SE"`, `"slices"`, `"survival"` or `"cumhaz"`
#'   (see details section).
...
plot.haz2tsPGAM <- function(x,
  ...
  # ---- Plot (log-) hazard, SEs surface, cumhazard or survival ----
