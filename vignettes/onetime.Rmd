...
This vignette demonstrates in detail how to use the package `TwoTimeScales` to estimate a smooth hazard model with one time scale, and how to plot the estimates.
...
When the aim of the analysis is to estimate a proportional hazard model, a different structure of the data is required (@Carollo:2024).
...
It is possible, and recommended, to provide the names of the covariates that one wishes to use in the PH model in the extra argument `covs`.
...
The variable `rx` includes 3 categories, and it is therefore represented in the regression matrix by two dummy variables (`rx_Lev` and `rx_Lev+5FU`).
...
In the following examples we show how to modify the arguments of the function, to obtain slightly different model specifications.
...
```
![](../vignettes/onetime_files/figure-html/fit1ts-grid-1.png)
...
![](../vignettes/onetime_files/figure-html/plot_haz1ts-1.png)
...
![](../vignettes/onetime_files/figure-html/plot_haz1ts-3-1.png)
...
![](../vignettes/onetime_files/figure-html/plot_haz1ts-3log-1.png)
...
![](../vignettes/onetime_files/figure-html/plot_haz1ts-4-1.png)
...
![](../vignettes/onetime_files/figure-html/CIs-lev-1.png)
...
![](../vignettes/onetime_files/figure-html/HRs-plot-1.png)
# References
