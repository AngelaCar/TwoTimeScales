...
```{r load-mod, cache=T, echo=F, warning=FALSE, message=FALSE}
dt2ts <- prepare_data(data = reccolon2ts,
                      u = "timer",
                      s_out = "timesr",
                      events = "status",
                      ds = 30, du = 30)
mod <- fit2ts(data2ts = dt2ts,
...
```{r basehaz, fig = TRUE, dependson="load-mod", fig.width=6, fig.align='center', fig.height=4.5}
plot(mod)
```

![](../vignettes/visualization_files/figure-html/basehaz-1.png)
...
![](../vignettes/visualization_files/figure-html/original-1.png)
...
```{r new-grid, fig = TRUE, chache = TRUE, dependson="load-mod", fig.width=6, fig.align='center', fig.height=4.5}
plot(mod,
...
![](../vignettes/visualization_files/figure-html/new-grid-1.png)

#### Plot the log-hazard

We can plot the hazard on the log-scale by changing the argument `loghazard = TRUE` in `plot_options`:

```{r loghaz, fig = TRUE, dependson="load-mod", fig.width=6, fig.align='center', fig.height=9}
par(mfrow = c(2,1), 
    font.main = 1)
plot(mod,
     plot_options = list(
...
![](../vignettes/visualization_files/figure-html/loghaz-1.png)
...
```{r log10haz, fig = TRUE, dependson="load-mod", fig.width=6, fig.align='center', fig.height=9}
par(mfrow = c(2,1), 
    font.main = 1)
plot(mod,
     plot_options = list(
...
![](../vignettes/visualization_files/figure-html/log10haz-1.png)
...
```{r cut-extra, fig = TRUE, dependson="load-mod", fig.width=6, fig.align='center', fig.height=9}
par(mfrow = c(2,1), 
    font.main = 1)
plot(mod,
...
```{r colors, fig = TRUE, dependson="load-mod", fig.width=6, fig.align='center', fig.height=4.5}
...
```{r SE, fig = TRUE, chache = TRUE, dependson="load-mod", fig.width=6, fig.align='center', fig.height=4.5}
plot(mod,
     which_plot = "SE",
...
```{r slices-u, fig = TRUE, chache = TRUE, dependson="load-mod", fig.width=6, fig.align='center', fig.height=4.5}
plot(mod,
     which_plot = "slices",
...
```{r survival, fig = TRUE, chache = TRUE, dependson="load-mod", fig.width=7, fig.align='center', fig.height=4.5}
...
```{r cumhaz, fig = TRUE, chache = TRUE, dependson="load-mod", fig.width=7, fig.align='center', fig.height=4.5}
