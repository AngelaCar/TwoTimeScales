...
```{r survival, fig = T, chache = T, dependson="load-mod", fig.width=6, fig.align='center', fig.height=4.5}
...
```{r cumhaz, fig = T, chache = T, dependson="load-mod", fig.width=6, fig.align='center', fig.height=4.5}
